            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li class="nav-link"><a href="../index.html#nosidees">Nos idées</a></li>
                  <li class="nav-link"><a href="gregoryB.html">Grégory Bubenheimer</a></li>
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../img/1280x680_015_basilique_clery_hd_chevet_faoade_nord.jpg')">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
            <h3 class="text-white font_clery">Un Nouveau Souffle Pour Cléry</h3>
            <h4 class="text-white">avec</h4>
              <h1 class="text-white">Erwan Bertrand-Bonvillain</h1>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center mb-5">
            <div class="d-flex">
              <div class="item-1 h">
                <img src="../spec/1/21.ERWAN BERTRAND BONVILLAIN.jpg" alt="Image" class="profil">
            </div>
            </div>
          </div>
      </div>
            ...
            <div class="row">
              <div class="col-lg-12 ml-auto">
                ...
                <ul class="list-unstyled">
                  ...
                  <li><a href="../index.html#nosidees">Nos idées</div></li>

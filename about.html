            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li><a href="index.html#nosidees" class="nav-link">Nos idées</a></li>
                  <li><a href="contacts/gregoryB.html" class="nav-link">Grégory Bubenheimer</a></li>
                  <li><a href="#" class="nav-link">Galerie</a></li>
                </ul>
              </nav>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="#" target="_blank" >Wakiweb</a>
            </p>
            </div>
          </div>
        </div>
